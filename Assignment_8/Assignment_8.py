...
new_set = (Set1 - (Set2 | Set3)) | (Set2 - (Set1 | Set3)) | (Set3 - (Set1 | Set2))
print("all elements that are in only one of three sets Set1, Set2, Set3 " + str(new_set))
...
new_set = ((Set1 & Set2) | (Set2 & Set3) | (Set1 & Set3)) - (Set1 & Set2 & Set3)
print("all elements that are in only two of three sets Set1, Set2, Set3 " + str(new_set))
